...
import br.com.thesharks.hanckathon.security.RestUnauthorizedEntryPoint;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	http.headers().disable().csrf().disable().authorizeRequests()
		...
		.antMatchers("/users/**").hasAnyAuthority("admin").anyRequest().authenticated().and().exceptionHandling()
